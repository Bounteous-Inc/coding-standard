...
class Ecg_Sniffs_Classes_Magento_Template_GodClassSniff extends Generic_Sniffs_PHP_ForbiddenFunctionsSniff
{
    ...
    public $forbiddenFunctions = array(
        '\bapp.*$'  => null,
        '\bgetModel.*$'  => null,
        '\bgetResourceModel.*$' => null,
        '\bregister.*$' => null,
        '\bunregister.*$' => null,
        '\bregistry.*$' => null,
        '\bgetModuleDir.*$' => null,
        '\bgetStoreConfig.*$' => null,
        '\bgetStoreConfigFlag.*$' => null,
        '\bdispatchEvent.*$' => null,
        '\bgetConfig.*$' => null,
        '\bgetSingleton.*$' => null,
        '\bgetControllerInstance.*$' => null,
        '\bgetResourceSingleton.*$' => null,
        '\bgetBlockSingleton.*$' => null,
        '\bgetResourceHelper.*$' => null,
        '\blog.*$' => null,
        '^assert$' => null,
